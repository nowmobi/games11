   ...
   */
    ...
    */
    ...
    CoinApp.showInterstitial = function (complete) {
        //如果是送审版 ***************游戏内自行完善***************
        console.log("CoinApp.showInterstitial1");
        if (!CoinApp.isEnableAD) {
            complete && complete();
            complete = null;
            return;
        ...
        if(window["gm_sdk"]){
            console.log("CoinApp.showInterstitial2");
    ...
    */
    ...
    CoinApp.GmShowRewardSuccess=null;
    CoinApp.showRewardedCallBack=function (success = null, failure = null) {
    ...
    CoinApp.showRewarded = function (success = null, failure = null) {
        ...
        if(window["gm_sdk"]){
            console.log("CoinApp.showRewarded");
            window["gm_sdk"].showBanner();
            success && success();
            success = null;
            return;
