...
function getBestScore(){
   ...
   // var iBestScore=bridge.storage.get(GAME_NAME+"_best_score", bridge.STORAGE_TYPE.LOCAL_STORAGE);
...
function getBoardState(){
   ...
   // var oState=bridge.storage.get(GAME_NAME+"_board", bridge.STORAGE_TYPE.LOCAL_STORAGE);
...
function getScoreSaved(){
    ...
    //var iScore=bridge.storage.get(GAME_NAME+"_tmp_score", bridge.STORAGE_TYPE.LOCAL_STORAGE);
...
function getSavedPieces(){
   ...
   // var oPieces=bridge.storage.get(GAME_NAME+"_pieces", bridge.STORAGE_TYPE.LOCAL_STORAGE);
