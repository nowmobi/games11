var CoinApp = (function () {
   ...
   */
    ...
    */
    ...
    //------------------------CG------------------------------------//
    CoinApp.showCgMidGame= function (complete = null) {
        console.log("showCgRewarded");
        if (!CoinApp.isEnableAD) {
            complete && complete();
            success = null;
            return;
        ...
        const callbacks = {
          ...
          if(window.CrazyGames!=null){
            complete && complete();
            window.CrazyGames.SDK.ad.requestAd("midgame", callbacks);
          }
          
    }
    CoinApp.showCgRewarded= function (success = null, failure = null) {
        console.log("showCgRewarded");
        if (!CoinApp.isEnableAD) {
            success && success();
            success = null;
...
//------------------------GD------------------------------------//
     ...
     * @description  处理gd广告
     */
    CoinApp.showGdRewarded = function (success = null, failure = null) {
        console.log("showApkRewarded");
        if (!CoinApp.isEnableAD) {
            success && success();
            success = null;
        ...
        .then(response => {
            console.log("showGdRewarded complete");
            if(success!=null){
                success();
            }
        ...
        .catch(error => {
            console.log("showGdRewarded error");
            if(failure!=null){
                failure();
            }
    ...
    CoinApp.showGdInterstitial = function (complete) {
        console.log("showGdInterstitial");
        if (!CoinApp.isEnableAD) {
            complete && complete();
            complete = null;
            return;
        ...
        gdsdk.showAd()
        .then(response => {
            console.log("showGdInterstitial complete");
            if(complete!=null){
                complete();
            }
        ...
        .catch(error => {
            console.log("showGdInterstitial error");
        // An error catched. Please don't give reward here.
        });
    }
//------------------------END------------------------------------//
...
//------------------------END------------------------------------//
    ...
    */
    ...
    CoinApp.showInterstitial = function (complete) {
        ...
        if(window.CrazyGames!=null){
            CoinApp.showCgMidGame(complete);
            return;
        }
        if(window["gdsdk"]){
            CoinApp.showGdInterstitial(complete);
            return
        }
        if(window["gm_sdk"]){
            window["gm_sdk"].showBanner();
            complete && complete();
            complete = null;
            return;
        }
    ...
    */
    ...
    CoinApp.showRewarded = function (success = null, failure = null) {
        ...
        if(window.CrazyGames!=null){
            CoinApp.showCgRewarded(success,failure);
            return;
        }
        if(window["gm_sdk"]){
            window["gm_sdk"].showBanner();
        ...
        if(window["gdsdk"]){
            CoinApp.showGdRewarded(success,failure);
            return
        }
        if (window.location && window.location.href && window.location.href.indexOf("localhost") != -1) {
            success && success();
