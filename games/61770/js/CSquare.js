function CSquare(iColumn, iRow, iType, iRotation, oContainer, oPiecesContainer, oRotatingPiecesContainer) {
    ...
    this.initSquare = function(){
        var data = {
            images: [s_oSpriteLibrary.getSprite("pipe0"),     // T SQUARE   
                     ...
                     s_oSpriteLibrary.getSprite("pipe4")],    // END/START SQUARE (START SQUARE IS ALWAYS ON!)
            frames: {width: SQUARE_SIZE, height: SQUARE_SIZE},
            animations: { PIPE_0_OFF : [ 0, 0, false],
                          PIPE_0_ON  : [ 1, 1, false],
    ...
    this.setEndSquareAnimations = function(){
        ...
        var data = {
            ...
            animations: {PIPE_END_OFF : [0,0,false],                         
    ...
    this.getOpenings = function(){
        ...
        switch(_iType){
            case SQUARE_T:        // [TOP, RIGHT, BOTTOM, LEFT]
                aPossibleOpenings = [[false, true, true, true],
                ...
                break;
            case SQUARE_I:
                aPossibleOpenings = [[false, true, false, true],
                ...
                break;
            case SQUARE_L:
                aPossibleOpenings = [[false, true, true, false],
            ...
            case SQUARE_END:
            case SQUARE_START:
                aPossibleOpenings = [[false, false, true, false],
    ...
    this.turnOnLed = function(bValue){
        ...
        if (bValue === true && _bLightedOn === false) {
            _bLightedOn = true;
            if (s_oGame.isStartGame() === true && 
                soundPlaying("light_on") === false) {
