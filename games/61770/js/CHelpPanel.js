function CHelpPanel(){
    ...
    this.initText = function(){
        ...
        var oText1 = new CTLText(_oGroup, 
                    CANVAS_WIDTH/2-iWidth/2, CANVAS_HEIGHT/2 - iHeight/2 - 180, iWidth, iHeight, 
    ...
    this.initAnimations = function(){
        ...
        var data = {
            ...
            animations: { PIPE_1_OFF : [ 0, 0, false],
                          PIPE_1_ON  : [ 1, 1, false],
        ...
        var data = {
            ...
            frames: {width: 202, height: 277},
            animations: { idle : [0,9,'stop'],
                          stop : [9,9,'stop']},
            framerate: 30
        };
        var oSpriteSheet = new createjs.SpriteSheet(data);
    ...
    this.startAnimation = function(iAnimation){
        ...
        createjs.Tween.get(_oSquare2)
            ...
            .to({rotation: iAngle}, 500, createjs.Ease.cubicOut)
            .call(function(){
