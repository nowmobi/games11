function CMain(oData) {
    ...
    this._initSounds = function () {
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'light_on',loop:false,volume:1, ingamename: 'light_on'});
        s_aSoundsInfo.push({path: './sounds/',filename:'light_off',loop:false,volume:1, ingamename: 'light_off'});        
        s_aSoundsInfo.push({path: './sounds/',filename:'timer',loop:false,volume:1, ingamename: 'timer'});
        s_aSoundsInfo.push({path: './sounds/',filename:'rotation',loop:false,volume:1, ingamename: 'rotation'});
